...
> Loaded via `▶ READ .ai-instructions/deep/challenges/code-review-training.md` on explicit request (after every 2–3 confirmed topics).
...
1. **Setup**: create a file in `.ai-state/playground/chapters/[NN]-[topic]/exercises/review-exercise-[name].[ext]` with 30–80 lines of **working but flawed** code.
