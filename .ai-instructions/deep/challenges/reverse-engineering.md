...
> Loaded via `▶ READ .ai-instructions/deep/challenges/reverse-engineering.md` on explicit request (after confirming 2–3 related topics).
...
1. Provide a working piece of code at `.ai-state/playground/chapters/[NN]-[topic]/reverse-engineering/re-[name].[ext]`: 40–120 lines of production-style code using confirmed patterns, no inline comments, may include intentional complexity.
