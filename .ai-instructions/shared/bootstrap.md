...
- `.ai-state/lessons/` — lesson files, required in all modes (▶ READ .ai-instructions/shared/enforcement.md)
- `.ai-state/notes/` — user notes, required in all modes (▶ READ .ai-instructions/shared/enforcement.md)

**Deep-centric:**
- `.ai-state/tutor-progress.md` — confirmed topics + revision schedule
- `.ai-state/lessons/archive/`
