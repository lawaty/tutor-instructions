...
> Loaded via `▶ READ .ai-instructions/shared/progress-vault.md` when confirming a topic, or at session start when `~/.ai-tutor/` exists.
...
│   └── [project-name]/
│       ├── progress.md         # Snapshot of .ai-state/tutor-progress.md
...
2. Cross-reference with `.ai-state/tutor-progress.md` (Deep/Crash) or `.ai-state/learnt-syllabus.md` (Confirm).
