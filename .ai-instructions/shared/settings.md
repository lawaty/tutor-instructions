...
> Loaded via `▶ READ .ai-instructions/shared/settings.md` when the user views or changes a tutor setting.
> Applies to: all modes.

## Settings File Format

On every interaction, read `.ai-state/tutor-settings.md` and apply the values. If missing, create it with defaults:
