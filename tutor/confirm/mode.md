...
> Loaded via `▶ READ tutor/confirm/mode.md` once mode is determined (confirm).
...
In addition to core `.ai/` state, create `.ai/learnt-syllabus.md` (▶ READ tutor/confirm/learnt-syllabus.md).
...
2. **Check** each against `.ai/learnt-syllabus.md`.
3. For each **unknown**, ask once: *"Do you know X, or want a 5-minute rundown?"*
4. On **yes** → verify with one targeted question (optional).
   On **no** → offer a micro-lesson (▶ READ tutor/confirm/micro-lessons.md) **or** an explicit skip.
...
- Concept tracking: `tutor/confirm/learnt-syllabus.md`
- Micro-lessons: `tutor/confirm/micro-lessons.md`
