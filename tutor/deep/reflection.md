...
> Loaded via `▶ READ tutor/deep/reflection.md` on quiz failure, struggle escalation, or lesson end.
> Applies to: Deep Learn Mode (Note-taking: Deep + light Crash).

## Mistake Reflection Log

**Storage**: `.ai/mistakes/`, one file per topic area.
...
**Rules**: tone is diagnostic, never judgmental; logs stay private to `.ai/`; the goal is a shrinking log.
