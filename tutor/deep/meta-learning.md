...
> Loaded via `▶ READ tutor/deep/meta-learning.md` every 8–10 topic confirmations, or when the user starts a new domain or shows a recurring meta-skill struggle.
